...
class NoeBitStream(NoeUnpacker):
	...
	def setBitOffset(self, ofs):
		noesis.bsSetBitOfs(self.h, ofs)
	def getBitOffset(self):
		return noesis.bsGetBitOfs(self.h)
	def pushOffset(self):
	...
	def readRevBits(self, numBits):
		return noesis.bsReadRevBits(self.h, numBits)
	def readBool(self):
...
class NoeMat43:
	def __init__(self, mat43 = identityMat43Tuple):
		if mat43 is identityMat43Tuple:
			mat43 = copy.deepcopy(mat43)
		self.mat43 = mat43
...
class NoeMat44:
	def __init__(self, mat44 = identityMat44Tuple):
		if mat44 is identityMat44Tuple:
			mat44 = copy.deepcopy(mat44)
		self.mat44 = mat44
...
class NoeMaterial:
	...
	def setOcclusionScale(self, occlScale):
		self.occlScale = occlScale
...
class NoeMesh:
	def __init__(self, triList, posList, name = "default", materialName = "default", glbVertIdx = -1, glbTriIdx = -1):
		...
		self.setBoneMap([])
		self.setUserStreams([])
		self.setFlatWeights(None, None, 0)
	...
	def setFlatWeights(self, idxList, valList, weightsPerVert):
		self.flatWeightIdx = idxList
		self.flatWeightVal = valList
		self.flatWeightsPerVert = weightsPerVert
